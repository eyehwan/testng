...
public class MethodGroupsHelper {
   ...
   *         groupRegExp. methods[] is the list of all the methods we are choosing from and method
   *         is
   *         the method that owns the dependsOnGroups statement (only used if a group is missing to
   *         flag
